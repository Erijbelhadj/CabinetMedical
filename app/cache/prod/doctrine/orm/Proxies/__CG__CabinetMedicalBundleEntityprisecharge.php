 ...
 */
class prisecharge extends \Cabinet\MedicalBundle\Entity\prisecharge implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'titre', 'dateprise', 'nom', 'prenom', 'datenaiss', 'pat');
    }
