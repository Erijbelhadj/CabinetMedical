...
/* CabinetMedicalBundle:actualite:new.html.twig */
class __TwigTemplate_fc4b706ce45ae19760b2ad1fa02cadffedcfcac6e2d8190e5b6401068282f145 extends Twig_Template
{
...
<div class=\"row\">
    <div class=\"col-md-12\">
        <form action=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("actualite_create"), "html", null, true);
        echo "\" method=\"post\" ";
        ...
        echo "
                            ...
                            <div class=\"form-group\">
                                ...
                                <div class=\"controls\">
                                    ";
        // line 48
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "file"), 'widget', array("attr" => array("style" => "width:100% ")));
        echo "
 ...
 ";
    ...
    {
        return "CabinetMedicalBundle:actualite:new.html.twig";
    }
    ...
    {
        return array (  129 => 68,  106 => 48,  95 => 40,  84 => 32,  71 => 22,  67 => 21,  58 => 17,  48 => 10,  44 => 9,  40 => 8,  36 => 7,  31 => 6,  28 => 5,);
    }
}
